    ...
    <div>
      ...
      <p>
        {`There are various ways to reduce weed growth and the most important factors are healthy plants and proper 
            ...
            with active rag weed seeds. I found out the hard way that mulch is essential to managing a garden of that size.`}
      </p>
      {`Water is the other essential factor. I prefer to use drip line irrigation. It is a flexible plastic line with 
            metered drip holes every 6-12 inches. It can be purchased at most home improvement stores. I connect a 3/4" 
            female hose connector to the end of the drip line and connect the hose to the house with a timer. I never have 
            to remember to water and the drip line system keeps the water at the roots.  `}
      <p></p>
      {`If you have a fence, consider raised planters around the perimeter and grow cherry tomatoes, 
            snap peas, beans or any other vine.`}
      <p>
        {`Pests can be a big problem with some plants. I hate cucumber beetles and squash bugs! That said a healthy plant 
            in good soil goes a long way in resisting disease and pests. I have found insecticidal soap to have decent results 
            on many insects and neem oil to work very good on both insects and fungus.`}
      </p>
      ...
      <p>
        {`I never thought about organic produce until my wife alerted me to scope of pesticides in our food. I have found 
            organic produce to taste better and is scientifically proven to have a higher nutritional value.`}
      </p>
